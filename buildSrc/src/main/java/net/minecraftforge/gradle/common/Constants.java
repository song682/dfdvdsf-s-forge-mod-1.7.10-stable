...
public class Constants {
    ...
    public static final String USER_AGENT = "Mozilla/5.0 ForgeGradle/1.2-lss233-rev (Windows NT 6.1; WOW64) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.95 Safari/537.11";
    ...
    public static final String MCP_URL = "https://crystal.app.lss233.com/repositories/minecraft/fernflower-fix-1.0.zip";
